...
QByteArray auth(QString log, QString pass)
{
    ...
    QByteArray result = "";
    //result.append(Db::getInstance()->auth(log, pass));
    qDebug() << result;
    return result;
}
...
{
    QByteArray result = "";
    //result.append(Db::getInstance()->reg(log, pass, mail, sock_desc));
    qDebug() << result;
...
QByteArray check_ans(QString numb, QString ans, int sock_desc)
{
    ...
    //res.append(Db::getInstance()->check_ans(numb, ans, sock_desc));
    qDebug()<<res;
    return res;
...
{
    QByteArray result;
    //result.append(Db::getInstance()->count_stat1(sock_desc).toInt());
    qDebug()<<result;
    return result;
}
...
{
    QByteArray result;
    //result.append(Db::getInstance()->count_stat2(sock_desc).toInt());
    qDebug()<<result;
    return result;
}
...
{
    QByteArray result;
    //result.append(Db::getInstance()->count_stat3(sock_desc).toInt());
    //qDebug()<<result;
    return result;
}
QByteArray change_sock_desc(QString login, int sock_desc)
{
    //qDebug()<<login+"tttt";
    QByteArray result;
    //result.append(Db::getInstance()->change_status(login, sock_desc));
    qDebug()<<result;
    return result;
}
...
QByteArray del_status(int sock_desc)
{
    //qDebug()<<"iiii";
    QByteArray result;
    //Db::getInstance()->del_status(sock_desc);
    return result;
}
